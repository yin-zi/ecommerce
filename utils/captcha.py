...
def generate_formula_captcha():
    num_a = random.randint(0, 9)
    num_b = random.randint(0, 9)
    captcha_ans = str(num_a * num_b)
    captcha_text = str(num_a) + 'x' + str(num_b) + '='
    captcha_im = ImageCaptcha().generate(captcha_text)
    return captcha_text, captcha_ans, captcha_im


if __name__ == '__main__':
    captcha_text, captcha_ans, captcha_im = generate_formula_captcha()
    print(captcha_text, captcha_ans)
